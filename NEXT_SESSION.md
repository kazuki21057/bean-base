...
最終更新: 2026-07-11(T2-2c・T2-1a・T2-1b・T2-3a〜c・T2-4a・T2-4b・T2-5a・T2-5b・T2-6・T2-7 完了、**Phase 2 終了**、/end によりセッション終了)
...
推奨: T3-10(PWAマニフェスト・アイコン整備)。依存なしで着手でき、T3-11(Hosting構築)→T3-12(ユーザーのスマホ確認)→T3-1(実機レイアウト確認)へと直列につながる。T3-11の初回 `firebase login` はユーザー操作が必要な点に注意。
